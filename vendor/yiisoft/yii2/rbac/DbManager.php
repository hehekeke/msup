...
class DbManager extends BaseManager
{
    ...
    // 更新权限数据
    public function updatePermesiion($name, $item){
    ...
    public function updateAssign($role, $userId) 
    {
        $assignment = new Assignment([
            'userId' => $userId,
            'roleName' => $role->name,
    ...
    public function removePermissions($name,$type) {
        ...
        if (!$this->supportsCascadeUpdate()) {
            ...
            $this->db->createCommand()
                 ->delete($this->itemChildTable, [$key=>$name])
                 ->execute();
            $this->db->createCommand()
