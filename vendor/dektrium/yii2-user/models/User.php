...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function scenarios()
    {
        return [
            ...
            'create'   => ['username', 'email', 'password', 'role', 'description'],
            'update'   => ['username', 'email', 'password', 'role', 'description'],
    ...
    public function rules()
    {
        return [
            ...
            ['role','required'],
            // ['description', 'string', 'on' => ['create', 'register', 'update']],
        ];
    }
    ...
    public function routes($role) {
        ...
        if (!$role || !array_key_exists($role, $routes) ) {
            $role = '普通用户';
        }
        $routes[$role]['home'] = Yii::$app->urlManager->createAbsoluteUrl($routes[$role]['home']);
        return $routes[$role];
    }
}
